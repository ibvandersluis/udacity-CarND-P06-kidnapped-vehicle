...
#include "particle_filter/json.hpp"
      ...
      if (length && length > 2 && data[0] == '4' && data[1] == '2') {
        ...
        if (s != "") {
          ...
          if (event == "telemetry") {
            ...
            std::copy(
              std::istream_iterator<float>(iss_x), std::istream_iterator<float>(),
            ...
            std::copy(
              std::istream_iterator<float>(iss_y), std::istream_iterator<float>(),
